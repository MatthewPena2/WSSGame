...
public class GameWindow {
    public void startGame(PlayerType selectedPlayer, int mapColumns, int mapRows, boolean isAuto, Difficulty selectedD){
        ...
        GamePanel gamePanel = new GamePanel(selectedPlayer, mapColumns, mapRows, isAuto, selectedD); //creates new game panel with selected player type
