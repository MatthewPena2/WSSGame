...
public class GameWindow {
    public void startGame(PlayerType selectedPlayer, int mapColumns, int mapRows){
        ...
        GamePanel gamePanel = new GamePanel(selectedPlayer, mapColumns, mapRows); //creates new game panel with selected player type
